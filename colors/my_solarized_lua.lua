...
local theme = {
  ...
  CursorLine = { bg = color07, sp = color10 },
  CursorLineNr = { fg = color14 },
  DiffAdd = { bg = green2, sp = green1 },
  DiffChange = { bg = color07, sp = color03 },
  DiffDelete = { bg = pink1 },
  ...
  SpellCap = { fg = blue1, sp = color01, bold = true },
  SpellLocal = { fg = purple1, sp = color01, bold = true },
  ...
  TelescopeBorder = { fg = black },
  TelescopeFrecencyScores = { fg = base2 },
  -- TelescopeMatching = { },
  -- TelescopeMultiIcon = { },
  -- TelescopeMultiSelection = { },
  -- TelescopeNormal = { bg = color07 },
  ...
  -- TelescopePreviewlWrite = { },
  -- TelescopePromptBorder = { },
  TelescopePromptCounter = { fg = green },
  -- TelescopePromptNormal = { fg = blue },
  TelescopePromptPrefix = { fg = black },
  -- TelescopePromptTitle = { fg = red },
  ...
  pandocLinkDefinition = { fg = color06, sp = color12, underline = true },
  ...
  pandocLinkTitleDelim = { fg = color14, sp = color12, underline = true },

...
local theme = {
  ...
  MarkviewPalette0 = { fg = "#aaaa58", bg = "#ebedf4" },
  MarkviewPalette0Fg = { fg = "#aa5858" },
  MarkviewPalette0Bg = { bg = "#ebedf4" },
  MarkviewPalette1 = { fg = "#aa5858", bg = "#ebedf4" },
  MarkviewPalette1Fg = { fg = "#aa5858" },
  MarkviewPalette1Bg = { bg = "#ebedf4" },
  MarkviewPalette2 = { fg = "#507030", bg = "#ebedf4" },
  MarkviewPalette2Fg = { fg = "#507030" },
  MarkviewPalette2Bg = { bg = "#ebedf4" },
  MarkviewPalette3 = { fg = "#1030a0", bg = "#ebedf4" },
  MarkviewPalette3Fg = { fg = "#1030a0" },
  MarkviewPalette3Bg = { bg = "#ebedf4" },
  MarkviewPalette4 = { fg = "#103040", bg = "#ebedf4" },
  MarkviewPalette4Fg = { fg = "#103040" },
  MarkviewPalette4Bg = { bg = "#ebedf4" },
  MarkviewPalette5 = { fg = "#505050", bg = "#ebedf4" },
  MarkviewPalette5Fg = { fg = "#505050" },
  MarkviewPalette5Bg = { bg = "#ebedf4" },
  MarkviewPalette6 = { fg = "#636363", bg = "#ebedf4" },
  MarkviewPalette6Fg = { fg = "#636363" },
  MarkviewPalette6Bg = { bg = "#ebedf4" },

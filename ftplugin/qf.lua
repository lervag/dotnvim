...
vim.keymap.set(
  "n",
  "d",
  ":set opfunc=personal#qf#delete_line<cr>g@",
  { buffer = true }
)
vim.keymap.set(
  { "n", "x" },
...
vim.keymap.set(
  "n",
  "f",
  ":silent call personal#qf#filter(1)<cr>",
  { buffer = true, silent = true }
)
vim.keymap.set(
  "n",
  "F",
  ":silent call personal#qf#filter(0)<cr>",
  { buffer = true, silent = true }
)
vim.keymap.set(
  "n",
  "<left>",
  ":call personal#qf#older()<cr>",
  { buffer = true, silent = true }
)
vim.keymap.set(
  "n",
  "<right>",
  ":call personal#qf#newer()<cr>",
  { buffer = true, silent = true }
)
